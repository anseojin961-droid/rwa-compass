export const T = {
  ko: {
    ...
    beginAnalysis: '분석 시작',
    estimatedTime: '예상 소요',
    analyzedAssetsLabel: '분석 자산',
    engineLabel: '엔진',
    completedAnswers: '완료 답변',
    currentStep: '현재 단계',
    dataStorage: '데이터 저장',
    localOnly: '로컬 전용',
    ...
    // ── Results dashboard ────────────────────────────────────────────────────
    yourProfile: '내 프로필',
    allocationTitle: '배분 제안',
    allocationCore: '핵심',
    allocationSatellite: '위성',
    allocationLearn: '학습',
  },
  ...
  en: {
    ...
    prevStep: 'Back',
    nextStep: 'Next',
    beginAnalysis: 'Analyze',
    estimatedTime: 'Est. Time',
    analyzedAssetsLabel: 'Assets',
    engineLabel: 'Engine',
    ...
    whyTexts: [
      ...
      'Your goal determines the center of gravity for expected yield distribution.',
      'Maximum drawdown tolerance is compared against each asset\'s historical drawdown.',
      'Each chain differs in gas fees, settlement speed, and liquidity distribution.',
      'Shorter horizons prioritize daily-liquidity assets in ranking.',
      'Redemption frequency is directly reflected in each asset\'s liquidity score.',
      'Your primary risk concern applies a weighted penalty to assets scoring high on that axis.',
    ],
    ...
    allocationCore: 'Core',
    allocationSatellite: 'Satellite',
    allocationLearn: 'Learn',
  },
  ...
  zh: {
    ...
    beginAnalysis: '开始分析',
    estimatedTime: '预计时间',
    analyzedAssetsLabel: '分析资产',
    engineLabel: '引擎',
    completedAnswers: '已完成',
    currentStep: '当前步骤',
    dataStorage: '数据存储',
    localOnly: '仅本地',
    ...
    whyTexts: [
      ...
      '最低投资额超出您预算的资产将被过滤排除。',
      '您的目标决定了预期收益率分布的重心。',
      '最大亏损承受度与各资产的历史回撤进行对比。',
      '各链在Gas费用、结算速度和流动性分布上各有不同。',
      '持有期越短，日流动性资产在排名中优先级越高。',
      '赎回周期直接反映在各资产的流动性评分中。',
      '您最担忧的风险轴会对该项得分较高的资产施加加权惩罚。',
    ],

    // ── Results dashboard ────────────────────────────────────────────────────
    yourProfile: '我的画像',
    allocationTitle: '配置建议',
    allocationCore: '核心',
    allocationSatellite: '卫星',
    allocationLearn: '学习',
  },
};
